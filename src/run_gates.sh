...
#
# Runs all 18 repository gates with the correct interpreter and working
...
#     scientific stack.
#   - the other 17 gates need the Anaconda interpreter (Python 3.13.x with
...
GATES=(
  ...
  "conda|gate_equip_share.py|F14: equipment-share decomposition build-graph isolation + re-derivation"
